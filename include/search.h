...
int32_t vec_i32v8n_count_gt(size_t size, const int32_t *src, int32_t value);
int16_t vec_i16v16n_count_gt(size_t size, const int16_t *src, int16_t value);
int8_t vec_i8v32n_count_gt(size_t size, const int8_t *src, int8_t value);
// any
