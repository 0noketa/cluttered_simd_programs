...
extern int32_t vec_i32x8n_get_min_index_i32(size_t size, const int32_t *src)
;
extern size_t vec_i32x8n_get_min_index(size_t size, const int32_t *src)
;
extern int32_t vec_i32x8n_get_max_index_i32(size_t size, const int32_t *src)
;
extern size_t vec_i32x8n_get_max_index(size_t size, const int32_t *src)
;
extern void vec_i32x8n_get_minmax_index_i32(size_t size, const int32_t *src, int32_t *out_min, int32_t *out_max)
;
...
extern int16_t vec_i16x16n_get_min_index_i16(size_t size, const int16_t *src)
;
extern size_t vec_i16x16n_get_min_index(size_t size, const int16_t *src)
;
extern int16_t vec_i16x16n_get_max_index_i16(size_t size, const int16_t *src)
;
extern size_t vec_i16x16n_get_max_index(size_t size, const int16_t *src)
;
extern int16_t vec_i16x16n_get_minmax_index_i16(size_t size, const int16_t *src, int16_t *out_min, int16_t *out_max)
;
...
extern int8_t vec_i8x32n_get_min_index_i8(size_t size, const int8_t *src)
;
extern size_t vec_i8x32n_get_min_index(size_t size, const int8_t *src)
;
extern int8_t vec_i8x32n_get_max_index_i8(size_t size, const int8_t *src)
;
extern size_t vec_i8x32n_get_max_index(size_t size, const int8_t *src)
;
extern void vec_i8x32n_get_minmax_index_i8(size_t size, const int8_t *src, int8_t *out_min, int8_t *out_max)
;
...
extern int32_t vec_i32x8n_count_gt(size_t size, const int32_t *src, int32_t value);
extern int16_t vec_i16x16n_count_gt(size_t size, const int16_t *src, int16_t value);
extern int8_t vec_i8x32n_count_gt(size_t size, const int8_t *src, int8_t value);
// any
...
extern int32_t vec_i32x8n_get_first_index(size_t size, const int32_t *src, int32_t element);
extern int16_t vec_i16x16n_get_first_index(size_t size, const int16_t *src, int16_t element);
extern int8_t vec_i8x32n_get_first_index(size_t size, const int8_t *src, int8_t element);
