...
size_t vec_i8v32n_get_manhattan_distance(size_t size, const int8_t *src1, const int8_t *src2);
...
int32_t vec_i32v8_sum_i32(size_t size, const int32_t *src);
uint32_t vec_u32v8_sum_u32(size_t size, const uint32_t *src);
int16_t vec_i16v16_sum_i16(size_t size, const int16_t *src);
size_t vec_i16v16_sum(size_t size, const int16_t *src);
uint16_t vec_u16v16_sum_u16(size_t size, const uint16_t *src);
size_t vec_u16v16_sum(size_t size, const uint16_t *src);
int8_t vec_i8v32_sum_i8(size_t size, const int8_t *src);
size_t vec_i8v32_sum(size_t size, const int8_t *src);
uint8_t vec_u8v32_sum_u8(size_t size, const uint8_t *src);
size_t vec_u8v32_sum(size_t size, const uint8_t *src);
...
void vec_i16v16n_set_seq(size_t size, const int16_t *src, int16_t start, int16_t diff);
void vec_i8v32n_set_seq(size_t size, const int8_t *src, int8_t start, int8_t diff);
...
int32_t vec_i32v8n_get_last_index(size_t size, const int32_t *src, int32_t element);
int16_t vec_i16v16n_get_last_index(size_t size, const int16_t *src, int16_t element);
int8_t vec_i8v32n_get_last_index(size_t size, const int8_t *src, int8_t element);

int32_t vec_i32v8n_get_nth_index(size_t size, const int32_t *src, int32_t element, size_t n);
int16_t vec_i16v16n_get_nth_index(size_t size, const int16_t *src, int16_t element, size_t n);
int8_t vec_i8v32n_get_nth_index(size_t size, const int8_t *src, int8_t element, size_t n);
...
void  vec_i32v8n_mask_unique(size_t size, const int32_t *src, int32_t *dst);
void  vec_i16v16n_mask_unique(size_t size, const int16_t *src, int16_t *dst);
void  vec_i8v32n_mask_unique(size_t size, const int8_t *src, int8_t *dst);


/* rescale */

// 10101010 -> 1100110011001100
int vec_i16v16n_rescale_i32v16n(size_t input_size, const int16_t *src, int32_t *dst);
int vec_i8v32n_rescale_i32v32n(size_t input_size, const int8_t *src, int32_t *dst);
int vec_i8v16n_rescale_i16v16n(size_t input_size, const int8_t *src, int16_t *dst);

// 10101010 -> 1000100010001000
int vec_i16v16n_sparse_i32v16n(size_t input_size, const int16_t *src, int32_t *dst);
int vec_i8v32n_sparse_i32v32n(size_t input_size, const int8_t *src, int32_t *dst);
int vec_i8v16n_sparse_i16v16n(size_t input_size, const int8_t *src, int16_t *dst);

// 1000110001001100 -> 10101010  OR
int vec_i32v16n_rescale_i16v16n(size_t input_size, const int32_t *src, int16_t *dst);
int vec_i32v32n_rescale_i8v32n(size_t input_size, const int32_t *src, int8_t *dst);
int vec_i16v32n_rescale_i8v32n(size_t input_size, const int16_t *src, int8_t *dst);

// 1000110001001100 -> 00100010  AND
int vec_i32v16n_densify_i16v16n(size_t input_size, const int32_t *src, int16_t *dst);
int vec_i32v32n_densify_i8v32n(size_t input_size, const int32_t *src, int8_t *dst);
int vec_i16v32n_densify_i8v32n(size_t input_size, const int16_t *src, int8_t *dst);
