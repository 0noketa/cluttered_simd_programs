...
void  vec_i32v86n_get_unique(size_t size, int32_t *src, int32_t *dst);
void  vec_i16v16n_get_unique(size_t size, int16_t *src, int16_t *dst);
void  vec_i8v32n_get_unique(size_t size, int8_t *src, int8_t *dst);
